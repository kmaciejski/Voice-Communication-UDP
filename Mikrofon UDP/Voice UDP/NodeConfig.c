...
const ConfigButtons_t PROGMEM ConfigButtonsInit = {								// ConfigButtons
						// Domyslne przypisania do przyciskow
	.btn1 = {'R', '1'},
	.btn2 = {'R', '2'},
	.btn3 = {'R', '3'},
			
};
ConfigButtons_t ConfigButtons;
...
void	configuration_init(void){
	...
	if(!EEPROM_getConfigButtons(&ConfigButtons)){
		FLASH_getConfigButtons(&ConfigButtons);
		EEPROM_setConfigButtons(&ConfigButtons);
	}
...
void print_boot_info(){
	...
	printf("BTN 1: %c%c\n", ConfigButtons.btn1[0], ConfigButtons.btn1[1]);
	printf("BTN 2: %c%c\n", ConfigButtons.btn2[0], ConfigButtons.btn2[1]);
	printf("BTN 3: %c%c\n", ConfigButtons.btn3[0], ConfigButtons.btn3[1]);
